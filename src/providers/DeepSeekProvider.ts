/**
 * DeepSeek Provider
 * Handles interactions with DeepSeek models (V3 Chat, R1 Reasoner)
 * 
 * DeepSeek uses OpenAI-compatible API with a different base URL
 * Adapted from ChatGPT's OpenAI implementation
 */
...
export class DeepSeekProvider extends LLMProvider {
    ...
    async generateText(params: TextGenParams): Promise<TextGenResult> {
        return this.withRetry(async () => {
            ...
            // Calculate cost (DeepSeek has cache hits support)
